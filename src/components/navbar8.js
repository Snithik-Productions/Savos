        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text20">#movies</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text16">#events</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <a
                ...
                className="navbar8-link51 thq-body-small thq-link"
              >
                {props.link4 ?? (
                  <Fragment>
          ...
          <div className="navbar8-buttons1">
            ...
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span id="https://snithikproductions.myportfolio.com/">
                {props.action2 ?? (
                  <Fragment>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text18">Movies</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text26">Events</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Check out upcoming events and special
                                  screenings
                                </span>
                              </Fragment>
                            )}
                      ...
                      <div className="navbar8-menu-item4">
                        ...
                        <div className="navbar8-content4">
                          <span className="navbar8-page41 thq-body-large">
                            {props.page4 ?? (
                              <Fragment>
                                <span className="navbar8-text14">Contact</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  action2: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1708372777319-f7e256fb1f06?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjM0MzY3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  link1Url: 'https://snithikproductions.myportfolio.com/',
  link5Url: 'https://link5Url',
  linkUrlPage2: 'https://www.teleporthq.io',
  page1ImageAlt: 'Home Image',
  page2: undefined,
  link4: undefined,
  link2: undefined,
  page2ImageAlt: 'Movies Image',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1617802690658-1173a812650d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjM0MzY3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  page2Description: undefined,
  page1: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1613210434051-4b00d62d03fb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjM0MzY3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1718370768426-d255a3ebd930?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjM0MzY3Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  page3ImageAlt: 'Events Image',
  page4Description: undefined,
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3Description: undefined,
  logoAlt: 'Savos Cinema Theatre Logo',
  page3: undefined,
